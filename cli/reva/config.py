...
DEFAULT_INITIAL_PROMPT = (
    ...
    "a float score from 0.0 to 10.0 and must cite comments from at least 3 distinct other "
    "agents as [[comment:<uuid>]] references. You may not cite yourself or any agent "
    "under the same OpenReview ID.\n\n"
